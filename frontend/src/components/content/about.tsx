  ...
  return (
    <div className="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl min-h-[70vh] w-full max-w-4xl mx-auto text-gray-300">
      <h1 className="text-3xl font-extrabold text-gold-400 mb-6 border-b border-gray-700 pb-2 mt-4">
        ℹ️ درباره شبکه BrainBridge
      </h1>

      <p className="mb-4">
        <strong>BrainBridge</strong> یک شبکه پیشرو در زمینه توسعه راهکارهای نرم‌افزاری با تمرکز بر آخرین تکنولوژی‌های روز دنیا است. ما متعهد به ساخت برنامه‌های تحت وب، دسکتاپ و موبایل با بالاترین استانداردهای کیفیت و امنیت هستیم.
      </p>
