...
export default function TermsPage() {
  return (
    <div className="bg-gray-800 p-6 sm:p-8 rounded-xl shadow-2xl min-h-[70vh] w-full max-w-4xl mx-auto text-gray-300">
      ...
      <p className="mb-4">
        این سند شامل شرایط و ضوابط حاکم بر استفاده شما از نرم‌افزارها و خدمات توسعه داده شده توسط شرکت <strong>BrainBridge</strong> است. با استفاده از خدمات ما، شما موافقت خود را با این قوانین اعلام می‌نمایید.
      </p>
      ...
      <p className="mb-4">
        کلیه حقوق مالکیت معنوی مربوط به نرم‌افزار، کد منبع، طراحی، و محتوای ارائه‌شده توسط BrainBridge متعلق به این شرکت می‌باشد. استفاده غیرمجاز یا کپی‌برداری ممنوع است.
      </p>
      ...
      <p className="mb-4">
        شرکت BrainBridge متعهد به ارائه به‌روزرسانی‌های فنی و امنیتی در فواصل زمانی منظم است.
      </p>
